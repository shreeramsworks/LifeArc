        ...
        <div className="p-4 sm:p-6 lg:p-8">
            <main className="max-w-4xl mx-auto space-y-8 bg-gray-800 rounded-xl border border-gray-700 p-8">
                ...
                <div className="prose prose-invert max-w-none text-gray-300">
                    ...
                    <p>By accessing and using LifeArrc (the "Service"), you accept and agree to be bound by the terms and provision of this agreement. In addition, when using this particular service, you shall be subject to any posted guidelines or rules applicable to such services. Any participation in this service will constitute acceptance of this agreement.</p>
                    
                    <h2 className="text-blue-400">2. Description of Service</h2>
                    <p>LifeArrc provides users with a suite of tools for calculating age, tracking family timelines, and exploring personal insights (the "Service"). All calculations and data storage are performed locally on the user's device. No personal data is transmitted to or stored on our servers.</p>
                    ...
                    <p>The Service is provided "as is" and "as available" without any warranties of any kind, either express or implied. LifeArrc does not warrant that the Service will be uninterrupted, error-free, or completely secure. The insights and calculations provided, especially those based on numerology or biorhythms, are for entertainment and informational purposes only and should not be considered as professional, medical, or scientific advice.</p>

                    <h2 className="text-blue-400">5. Limitation of Liability</h2>
                    <p>In no event shall LifeArrc, nor its owners or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
                    ...
                    <p>Any claim relating to LifeArrc's website shall be governed by the laws of the service provider's home jurisdiction without regard to its conflict of law provisions.</p>
                </div>
            </main>
        </div>
    );
