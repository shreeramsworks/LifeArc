        ...
        <div className="p-4 sm:p-6 lg:p-8">
            <main className="max-w-4xl mx-auto space-y-8 bg-gray-800 rounded-xl border border-gray-700 p-8">
                ...
                <div className="prose prose-invert max-w-none text-gray-300">
                    ...
                    <p>We are passionate about precision. LifeArrc utilizes high-precision calculations based on Julian Day Numbers to avoid common errors found in other age calculators, ensuring accuracy regardless of timezones or daylight saving time. Our tools are built with modern web technologies to be fast, responsive, and accessible on any device.</p>
                    ...
                    <p>LifeArrc is developed and maintained by a small team of independent designers and developers who are passionate about data visualization, personal privacy, and creating meaningful web experiences. We believe in building useful, transparent tools that respect the user.</p>

                    <h2 className="text-blue-400">Our Expert Contributors</h2>
                    <p>LifeArrc's content is enriched by a team of passionate experts who contribute their knowledge to our blog and insight descriptions. Our goal is to provide you with well-researched, thoughtful content to accompany our tools.</p>
