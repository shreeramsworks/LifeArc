...
export const articles: Article[] = [
    ...
    },
    {
        ...
        content: React.createElement("div", { className: "prose prose-invert max-w-none text-gray-300" },
            ...
            React.createElement("p", null, "The journey begins with what you know. Here are some simple steps to get started using the LifeArrc Family Tracker:"),
            React.createElement("ol", null,
    ...
    },
    {
        ...
        summary: 'LifeArrc uses Julian Day Numbers for its core calculations. Learn what this system is, why it was invented by astronomers, and how it eliminates common time-tracking errors from timezones and daylight saving.',
        author: authors.EVELYN_REED,
        ...
        content: React.createElement("div", { className: "prose prose-invert max-w-none text-gray-300" },
            ...
            React.createElement("p", null, "At LifeArrc, we use the JDN for our core time calculations. Here's why that matters:"),
            React.createElement("ul", null,
    ...
    },
    {
        ...
        summary: 'Want to build your family tree but don\'t know where to start? This guide provides practical steps for gathering information, organizing your findings, and using tools like LifeArrc to bring your family history to life.',
        author: authors.JAMES_CARTER,
        ...
        content: React.createElement("div", { className: "prose prose-invert max-w-none text-gray-300" },
            ...
            React.createElement("p", null, "As you gather information, it's crucial to keep it organized. Digital tools are excellent for this. When you add a member to the LifeArrc Family Tracker, you're creating a digital record that includes their name, relationship to you, and date of birth. This prevents confusion and helps you see the emerging patterns in your family's timeline."),
    ...
    },
    {
        ...
        content: React.createElement("div", { className: "prose prose-invert max-w-none text-gray-300" },
            ...
            React.createElement("p", null, "Our brain organizes our memories into a coherent narrative—our life story. This isn't just a chronological list of events. We create chapters, turning points, and recurring themes. Tools like LifeArrc's 'Age @ Historical Events' tap into this by helping you place your personal story within the context of the larger story of history."),
    ...
    },
    {
        ...
        content: React.createElement("div", { className: "prose prose-invert max-w-none text-gray-300" },
            ...
            React.createElement("p", null, "In stark contrast, eternalism argues that the past, present, and future are all equally real and exist simultaneously. This view is often called the 'block universe' theory, which is supported by Einstein's theory of relativity. It imagines the entirety of spacetime as a single, four-dimensional block. The dinosaurs, your present self reading this article, and the events of the 22nd century all exist within this block. The 'flow' of time is just our consciousness experiencing successive slices of this block."),
            React.createElement("h3", { className: "text-blue-400" }, "The Growing Block Universe"),
            React.createElement("p", null, "A hybrid theory, the growing block universe, suggests that the past and present are real, but the future is not. Time is like a growing block of spacetime. The present is the edge of this block, where new moments are constantly coming into existence. The past is the solid, unchangeable block that has already been built."),
