        ...
        <div className="space-y-24">
            ...
            <section className="text-center mx-auto py-20 sm:py-24 px-4 sm:px-6 lg:px-8">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white">
                    Private Personal Insights &amp; Family Tools
                </h1>
                <p className="mt-6 text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto">
                   Discover your personal insights with complete privacy. Our age calculator, family tracker, and numerology tools are 100% browser-based with zero data collection.
                </p>
                <LiveMiniCalculator />
                <button
            ...
            <section id="tools-showcase" className="mx-auto px-4 sm:px-6 lg:px-8">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                     <div className="bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-700 text-center flex flex-col items-center">
                        ...
                        <p className="text-gray-300 flex-grow">Calculate your age to the second with our secure age calculator. Features a birthday countdown and world clock, with no data stored.</p>
                     ...
                     <div className="bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-700 text-center flex flex-col items-center">
                        ...
                        <p className="text-gray-300 flex-grow">Build a family timeline with our offline family tree software. Track live ages and statistics with zero data sharing. Your data never leaves your device.</p>
                      ...
                      <div className="bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-700 text-center flex flex-col items-center">
                        ...
                        <p className="text-gray-300 flex-grow">Discover your Vedic Destiny number and favorable days with our private numerology calculator. Get anonymous readings without sharing personal data.</p>
            ...
            <section className="mx-auto text-center px-4 sm:px-6 lg:px-8">
             ...
             {/* Add Review Section */}
            <section id="add-review" className="mx-auto bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-700 min-h-[510px] flex items-center justify-center px-4 sm:px-6 lg:px-8">
                 {isReviewSubmitted ? (
